...
# killall -9 rosmaster # for kiling all nasters
...
def main(args):
    ...
    p_ros_core = start_process(['/opt/ros/noetic/bin/roscore'],
...
if __name__ == '__main__':
    ...
    python  start_ros.py --script_node /home/radioon/catkin_ws/src/spoproject/scripts/talker.py -l /home/radioon/catkin_ws/src/spoproject/scripts
    ...
    parser.add_argument('--script_node', type=str,
                        default='/home/radioon/catkin_ws/src/spoproject/scripts/Trecker_with6acord.py')
    parser.add_argument('--dpath_logs', '-l', type=str,
                        default='/home/radioon/catkin_ws/src/spoproject/scripts')
